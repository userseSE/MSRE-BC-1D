...
#pragma HLS UNROLL
    ...
    temp_dydt[0] = params.u_L - temp_dydt[0];
    temp_dydt[Nx - 1] = params.u_H - temp_dydt[Nx - 1];
    temp_dydt[Nx] = params.v_L - temp_dydt[Nx];
    temp_dydt[2 * Nx - 1] = params.v_H - temp_dydt[2 * Nx - 1];
