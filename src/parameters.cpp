...
//       B1[i][j] = I[i][j] + 0.5 * params.dt * params.V1 * params.D1 * D3[i][j];
//       B2[i][j] = I[i][j] + 0.5 * params.dt * params.V2 * params.D2 * D3[i][j];
//     }
//   }
//   invert_LU(params.A1);
//   invert_LU(params.A2);
//   // sparse_csr(B1, params.B1_csr);
//   // sparse_csr(B2, params.B2_csr);

//   // // Save parameters to files
//   //   saveMatrixToFile("phi1_0", params.phi1_0, N, 1);
//   //   saveMatrixToFile("phi2_0", params.phi2_0, N, 1);
//     // saveMatrixToFile("c1", params.c1, 1, N);
