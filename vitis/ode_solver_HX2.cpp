...
public:
  ...
  void solve(const OdeFuncPointer_hx2 ode_func, float y[length_hx], int step,
             Param_HX2 &params, float t0 = 0.0,
             float t1 = 1.0) {
    float t = t0;
...
void calculateNorm(const float arr[length_hx], float &norm) {
  ...
  void rkf45_step_hx(const OdeFuncPointer_hx2 ode_func, float t,
                  const float y[length_hx], Param_HX2 &params, float h, float y_new[length_hx],
    ...
    // Compute the stages
    float k1[length_hx], k2[length_hx], k3[length_hx], k4[length_hx], k5[length_hx], k6[length_hx];
...
void ode_solver_hx2(float y[length_hx], OdeFuncPointer_hx2 ode_func, int step,
                      Param_HX2 &params) {
