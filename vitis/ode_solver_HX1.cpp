...
public:
  ...
  void solve(const OdeFuncPointer_hx1 ode_func, float y[length_hx], int step,
             Param_HX1 &params, float t0 = 0.0, float t1 = 1.0) {
...
void calculateNorm(const float arr[length_hx], float &norm) {
  ...
  void rkf45_step_hx(const OdeFuncPointer_hx1 ode_func, float t,
    ...
    static const float c[] = {16.0 / 135.0,      0.0,         6656.0 / 12825.0,
...
void ode_solver_hx1(float y[length_hx], OdeFuncPointer_hx1 ode_func, int step, Param_HX1 &params) {
