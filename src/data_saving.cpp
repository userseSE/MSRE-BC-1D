...
void save_spacial_results(const std::vector<double>& phi, 
    ...
    std::vector<std::vector<double>> segmented_ci(6, std::vector<double>(N));
    for (int i = 0; i < 6; ++i) {
        std::copy(ci.begin() + i * N, ci.begin() + (i + 1) * N, segmented_ci[i].begin());
    }
    std::vector<std::vector<double>> transposed_ci(N, std::vector<double>(6));
    ...
    std::vector<std::vector<double>> transposed_temperature_core(Nx, std::vector<double>(2));
    ...
    std::vector<std::vector<double>> transposed_temperature_HX1(Nx, std::vector<double>(2));
    ...
    std::vector<std::vector<double>> transposed_temperature_HX2(Nx, std::vector<double>(2));
