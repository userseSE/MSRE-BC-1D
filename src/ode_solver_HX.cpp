...
public:
  ...
  void solve(const OdeFuncPointer_hx ode_func, float y[length_hx], int step,
             Parameters &params, float t0 = 0.0,
             float t1 = 1.0) {
...
void calculateNorm(const float arr[length_hx], float &norm) {
  ...
  void rkf45_step_hx(const OdeFuncPointer_hx ode_func, float t,
                  const float y[length_hx], Parameters &params, float h, float y_new[length_hx],
...
void ode_solver_hx(float y[length_hx], OdeFuncPointer_hx ode_func, int step,
                      Parameters &params) {
